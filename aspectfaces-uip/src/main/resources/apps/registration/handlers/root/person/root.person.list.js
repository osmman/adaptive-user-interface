...
params["ejb.name"] = "java:global/PersonService";
...
for(i = 0; i < modelsCount; i++) {
	...
	interfaceBuilder.introduceElement(null, "public.display", null);
	interfaceBuilder.introduceLabel();
	interfaceBuilder.createProperty("Name", "title", "cz.cvut.fel.aui.model.PersonInfo.person.list." + i + ":firstName", null);
	interfaceBuilder.finalizeLabel();
	interfaceBuilder.finalizeElement();
	...
	interfaceBuilder.introduceElement(null, "public.display", null);
	interfaceBuilder.introduceLabel();
	interfaceBuilder.createProperty("Surename", "title", "cz.cvut.fel.aui.model.PersonInfo.person.list." + i + ":lastName", null);
	interfaceBuilder.finalizeLabel();
	interfaceBuilder.finalizeElement();
